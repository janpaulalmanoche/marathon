...
<head>
  ...
  <!--add time picker to input field-->
  <script>
  ...
  <div class="wrapper ">
    <div class="sidebar" data-color="blue"><!--Tip 1: You can change the color of the sidebar using: data-color="blue | green | orange | red | yellow"-->
      ...
      <div class="sidebar-wrapper" id="sidebar-wrapper">
        <ul class="nav">
          <li class="{{ 'organizerdb' == request()->path() ? 'active' : '' }}">
            <a href="/organizerdb">
              <i class="now-ui-icons design_app"></i>
              <p>Organizers Table</p>
            </a>
          </li>
          <li class="{{ 'role-org-events-table' == request()->path() ? 'active' : '' }}">
            <a href="/role-org-events-table">
